...
dat = dat.loc[:, ['ZIP CODE','RESIDENTIAL UNITS','COMMERCIAL UNITS','TOTAL UNITS','LAND SQUARE FEET','GROSS SQUARE FEET','YEAR BUILT','SALE PRICE','BUILDING CLASS SALE QTF','TAX CODE','IS BUILDING CLASS CHANGED','IS TAX CLASS CHANGED']]
