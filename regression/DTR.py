...
dat = dat.loc[:, ['BOROUGH', 'NEIGHBORHOOD', 'TAX CLASS AT TIME OF SALE', 'RESIDENTIAL UNITS','COMMERCIAL UNITS','TOTAL UNITS','LAND SQUARE FEET','GROSS SQUARE FEET','YEAR BUILT','SALE PRICE','IS BUILDING CLASS CHANGED','IS TAX CLASS CHANGED']]
