...
dat = dat.loc[:, ['BOROUGH', 'BLOCK', 'LOT', 'ZIP CODE', 'TAX CLASS AT TIME OF SALE','RESIDENTIAL UNITS','COMMERCIAL UNITS','TOTAL UNITS','LAND SQUARE FEET','GROSS SQUARE FEET','YEAR BUILT','SALE PRICE','BUILDING CLASS SALE QTF', 'BUILDING CLASS PRESENT QTF', 'TAX CLASS PRESENT QTF']]
